...
type Props = {
  ...
  targetId: number;
  /** Render prop for the trigger — lets callers reuse their own button/menu-item styling. */
  trigger: (open: () => void) => React.ReactNode;
};

export default function ReportModal({ targetType, targetId, trigger }: Props) {
