      ...
      {isOpen && (
        ...
        >
          <div className="bg-white dark:bg-zinc-900 rounded-lg p-6 w-96 border border-zinc-200 dark:border-zinc-800">
            ...
            <div className="border-2 border-dashed border-zinc-300 dark:border-zinc-800 rounded-lg p-6 text-center">
              <input
                type="file"
                accept="image/*"
            ...
            <div className="flex gap-2 mt-6">
              <button
                ...
                disabled={uploading}
                className="flex-1 px-4 py-2 rounded-md border border-zinc-200 dark:border-zinc-800 text-sm font-medium text-zinc-700 dark:text-zinc-200 hover:bg-zinc-50 dark:hover:bg-zinc-800 disabled:opacity-60 cursor-pointer"
              >
                გაუქმება
              </button>
            </div>
