...
export default function AccountMenu({ user }: Props) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        <span className="inline-block h-8 w-8 rounded-md bg-zinc-200 dark:bg-zinc-700 text-sm leading-8 text-center text-zinc-700 dark:text-zinc-100">{(user?.alias || 'U').charAt(0).toUpperCase()}</span>
