...
export default function AboutPage() {
  ...
  const roadmap = [
    ...
    { title: "პოსტის დეტალები და კომენტარები", status: "მიმდინარე", note: "ამჟამად პოსტი მხოლოდ იქმნება და გააჩნია ავტორი, კონტენტი, საჭიროა დაემატოს კომენტარები, გამოცნობის ისტორია" },
  ];
