...
export const aboutFeatures: AboutEntry[] = [
  { title: "ინვენტარი", desc: "ნივეთების შეგროვება, რომელიც შეისაძლებელია მიიღო მისიიდან, მიღწევიდან ან პოსტის დადებისას მალულად კონკრეტული ადგილიდან საქართველოს ტერიტორიაზე." },
  { title: "თამაში", desc: "დამალობანა, მომხმარებელი საიდუმლოდ აქვეყნენს თავის ან რაიმე დამალული ნივთის ლოკაციას და სხვა მომხმარებლები ცდილობენ მიგნებას." },
...
export const aboutRoadmap: RoadmapEntry[] = [
  { title: "AI", status: "მიმდინარე", note: "სათაურის კრეატიული გენერირება სურათის მიხედვით AI-ს დახმარებით" },
];
